...
public class Kilometer {
    public static void main(String[] args) {
        ...
        System.out.println("1. Kilometer zu Meilen");
        System.out.println("2. Meilen zu Kilometer");
        int choice = scanner.nextInt();
        double result;

        if (choice == 1) {
            System.out.println("Bitte geben Sie die Anzahl der Kilometer ein:");
            double kilometers = scanner.nextDouble();
            result = kilometersToMiles(kilometers);
            System.out.println(kilometers + " Kilometer entsprechen " + result + " Meilen.");

        } else if (choice == 2) {
            System.out.println("Bitte geben Sie die Anzahl der Meilen ein:");
            double miles = scanner.nextDouble();
            result = milesToKilometers(miles);
            System.out.println(miles + " Meilen entsprechen " + result + " Kilometer.");
    ...
    // Methode zur Umwandlung von Meilen in Kilometer
